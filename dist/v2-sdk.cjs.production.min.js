...
var x = 'setPrototypeOf' in Object,
  ...
  O = (function() {
    ...
    t.getAddress = function(t, e) {
      return (function(t) {
        ...
        return u.getCreate2Address(
          e,
          o.keccak256(['bytes'], [o.pack(['address', 'address'], [s.address, i[1].address])]),
          a[s.chainId]
        )
    ...
    var h = t.prototype
    return (
      (h.involvesToken = function(t) {
        return t.equals(this.token0) || t.equals(this.token1)
      }),
      (h.priceOf = function(t) {
        return this.involvesToken(t) || r(!1), t.equals(this.token0) ? this.token0Price : this.token1Price
      }),
      (h.reserveOf = function(t) {
        return this.involvesToken(t) || r(!1), t.equals(this.token0) ? this.reserve0 : this.reserve1
      }),
      (h.getOutputAmount = function(o) {
        if (
          (this.involvesToken(o.currency) || r(!1),
          e.equal(this.reserve0.quotient, c) || e.equal(this.reserve1.quotient, c))
        )
          throw new I()
        var u = this.reserveOf(o.currency),
          i = this.reserveOf(o.currency.equals(this.token0) ? this.token1 : this.token0),
          a = e.multiply(o.quotient, f),
          s = e.multiply(a, i.quotient),
          p = e.add(e.multiply(u.quotient, d), a),
          l = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(s, p))
        if (e.equal(l.quotient, c)) throw new E()
        return [l, new t(u.add(o), i.subtract(l))]
      }),
      (h.getInputAmount = function(o) {
        if (
          (this.involvesToken(o.currency) || r(!1),
          e.equal(this.reserve0.quotient, c) ||
            e.equal(this.reserve1.quotient, c) ||
        ...
        var u = this.reserveOf(o.currency),
          ...
          s = e.multiply(e.subtract(u.quotient, o.quotient), f),
          l = n.CurrencyAmount.fromRawAmount(
            o.currency.equals(this.token0) ? this.token1 : this.token0,
            e.add(e.divide(a, s), p)
          )
        return [l, new t(i.add(l), u.subtract(o))]
      }),
      (h.getLiquidityMinted = function(t, o, u) {
        t.currency.equals(this.liquidityToken) || r(!1)
        var i,
          a = o.currency.sortsBefore(u.currency) ? [o, u] : [u, o]
        if (((a[0].currency.equals(this.token0) && a[1].currency.equals(this.token1)) || r(!1), e.equal(t.quotient, c)))
          i = e.subtract(n.sqrt(e.multiply(a[0].quotient, a[1].quotient)), s)
        else {
        ...
        if (!e.greaterThan(i, c)) throw new E()
        return n.CurrencyAmount.fromRawAmount(this.liquidityToken, i)
      }),
      (h.getLiquidityValue = function(t, o, u, i, a) {
        var s
        if (
          (void 0 === i && (i = !1),
          ...
          if (e.equal(p, c)) s = o
            ...
            var f = n.sqrt(e.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              d = n.sqrt(p)
            if (e.greaterThan(f, d)) {
              var h = e.multiply(o.quotient, e.subtract(f, d)),
                m = e.add(e.multiply(f, l), d),
                y = e.divide(h, m)
              s = o.add(n.CurrencyAmount.fromRawAmount(this.liquidityToken, y))
            } else s = o
          }
        } else s = o
        return n.CurrencyAmount.fromRawAmount(
          t,
          e.divide(e.multiply(u.quotient, this.reserveOf(t).quotient), s.quotient)
        )
      }),
      m(t, [
        {
  ...
  P = (function() {
    function t(t, e, n) {
      ...
      for (var i, a = [u], s = w(t.entries()); !(i = s()).done; ) {
        var c = i.value,
          p = c[1],
          l = a[c[0]]
...
var _ = (function() {
  function t(t, e, o) {
    ...
    if (o === n.TradeType.EXACT_INPUT) {
      ...
      for (var s = t.path.length - 1; s > 0; s--) {
        var c = t.pairs[s - 1].getInputAmount(u[s])
        u[s - 1] = c[0]
      }
  ...
  return (
    (e.minimumAmountOut = function(t) {
      if ((t.lessThan(c) && r(!1), this.tradeType === n.TradeType.EXACT_OUTPUT)) return this.outputAmount
      var e = new n.Fraction(p)
        .add(t)
        .invert()
    ...
    (e.maximumAmountIn = function(t) {
      if ((t.lessThan(c) && r(!1), this.tradeType === n.TradeType.EXACT_INPUT)) return this.inputAmount
      var e = new n.Fraction(p).add(t).multiply(this.inputAmount.quotient).quotient
      return n.CurrencyAmount.fromRawAmount(this.inputAmount.currency, e)
    }),
    (t.bestTradeExactIn = function(e, o, u, i, a, s, p) {
      var l = void 0 === i ? {} : i,
        f = l.maxNumResults,
        d = void 0 === f ? 3 : f,
        h = l.maxHops,
      ...
      void 0 === a && (a = []),
        ...
        m > 0 || r(!1),
        o === s || a.length > 0 || r(!1)
      for (var y = s.wrapped, v = u.wrapped, A = 0; A < e.length; A++) {
        var T = e[A]
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(a, [T]), o.currency, u), o, n.TradeType.EXACT_INPUT), d, C)
          else if (m > 1 && e.length > 1) {
            var k = e.slice(0, A).concat(e.slice(A + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: d, maxHops: m - 1 }, [].concat(a, [T]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, a, s, p) {
      var l = void 0 === i ? {} : i,
        f = l.maxNumResults,
        d = void 0 === f ? 3 : f,
        h = l.maxHops,
      ...
      void 0 === a && (a = []),
        ...
        m > 0 || r(!1),
        u === s || a.length > 0 || r(!1)
      for (var y = s.wrapped, v = o.wrapped, A = 0; A < e.length; A++) {
        var T = e[A]
        if (
          (T.token0.equals(y.currency) || T.token1.equals(y.currency)) &&
          !T.reserve0.equalTo(c) &&
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([T].concat(a), o, u.currency), u, n.TradeType.EXACT_OUTPUT), d, C)
          else if (m > 1 && e.length > 1) {
            var k = e.slice(0, A).concat(e.slice(A + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: d, maxHops: m - 1 }, [T].concat(a), q, p)
          }
        }
      }
      return p
  ...
  return (
    (t.swapCallParameters = function(t, e) {
      ...
      var i,
        ...
        p = B(t.maximumAmountIn(e.allowedSlippage)),
        l = B(t.minimumAmountOut(e.allowedSlippage)),
      ...
      switch (t.tradeType) {
        ...
        case n.TradeType.EXACT_OUTPUT:
          h && r(!1),
            o
              ? ((i = 'swapETHForExactTokens'), (a = [l, f, c, d]), (s = p))
              : u
              ? ((i = 'swapTokensForExactETH'), (a = [l, p, f, c, d]), (s = '0x0'))
              : ((i = 'swapTokensForExactTokens'), (a = [l, p, f, c, d]), (s = '0x0'))
      }
      return { methodName: i, args: a, value: s }
    }),
    t
  )
})()
;(exports.FACTORY_ADDRESS = i),
  ...
  (exports.InsufficientInputAmountError = E),
